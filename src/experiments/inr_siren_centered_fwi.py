...
class INRSIRENCenteredFWI:
    name = "inr_siren_centered_fwi"
    ...
    def run(self, case_id: int, data_dir: Path, run_dir: Path):
        ...
        for epoch in range(epochs):
            ...
            # through the SIREN so this external gradient updates network weights.
            ...
            tv_loss_value = 0.0
            if use_tv:
                # TV is applied on the generated gamma image and backpropagated
                # normally through PyTorch, in addition to the adjoint gradient.
