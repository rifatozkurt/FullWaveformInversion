...
class INR(torch.nn.Module):
    def __init__(self, hidden_features, hidden_layers, gamma0):
        super().__init__()
        self.gamma0 = gamma0
        layers = []
        in_features = 2
    ...
    def forward(self, coords):
        x = self.net(coords)
        return x * (1 - self.gamma0) + self.gamma0


class INRSIREN(torch.nn.Module):
    def __init__(self, hidden_features, hidden_layers, gamma0, omega0=30):
        super().__init__()
        self.gamma0 = gamma0
        self.omega0 = omega0
